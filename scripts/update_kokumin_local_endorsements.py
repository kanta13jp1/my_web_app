...
def render_dart_fallback(snapshot: dict) -> str:
    ...
    lines = [
        ...
        "",
        f"const String dpjOfficialEndorsementSourceUrl = {_dart_string(snapshot['sourceUrl'])};",
        f"const String dpjOfficialEndorsementSourceAsOf = {_dart_string(snapshot['sourceAsOf'])};",
        f"const String dpjOfficialEndorsementSourceDocumentSha256 = {_dart_string(snapshot['sourceDocumentSha256'])};",
