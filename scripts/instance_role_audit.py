...
EXPECTED_TERRITORY: dict[str, list[str]] = {
    "vscode": ["lib/", "pages/", "widgets/"],
    "win":    ["docs/", "supabase/migrations/", "scripts/video/", "memory/"],
    "ps1":    [".github/workflows/", "scripts/check_"],
    "ps2":    ["docs/blog-drafts/", "docs/dev-to-drafts/", "scripts/blog_"],
    "ps3":    ["lib/pages/comparison", "supabase/migrations/.*ai_university"],
    "ps4":    ["lib/pages/comparison_page", "supabase/migrations/.*competitors"],
    "ps5":    ["supabase/functions/", "lib/pages/"],
    "ps6":    ["scripts/horse_racing/", "lib/pages/horse_racing"],
    "codex1": [".github/workflows/", "supabase/functions/"],
    "codex2": [".github/workflows/", "supabase/functions/", "scripts/"],
}
