...
class PublicMemoService {
  ...
  Future<bool> publishMemo({
    ...
    try {
      ...
      AppLogger.error('Failed to publish memo',
  ...
  Future<bool> unpublishMemo(int noteId, String userId) async {
    try {
      ...
      AppLogger.error('Failed to unpublish memo',
          error: e, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<List<PublicMemo>> getPublicMemos({
    ...
    try {
      ...
      AppLogger.error('Failed to get public memos',
          error: e, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<List<PublicMemo>> getTrendingMemos({int limit = 10}) async {
    try {
      ...
      AppLogger.error('Failed to get trending memos',
          error: e, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<void> incrementViewCount(int memoId) async {
    try {
      ...
      AppLogger.error('Failed to increment view count',
          error: e, stackTrace: stackTrace);
    }
  }
  ...
  Future<bool> unlikeMemo(int memoId, String userId) async {
    try {
      ...
      AppLogger.error('Failed to unlike memo',
          error: e, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<bool> hasUserLikedMemo(int memoId, String userId) async {
    try {
      ...
      AppLogger.error('Failed to check if user liked memo',
          error: e, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<List<PublicMemo>> getUserPublicMemos(String userId) async {
    try {
      ...
      AppLogger.error('Failed to get user public memos',
          error: e, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getPopularCategories(
    ...
    try {
      ...
      AppLogger.error('Failed to get popular categories',
          error: e, stackTrace: stackTrace);
      return [];
    }
  }
