    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(icon: const Icon(Icons.devices), text: 'デバイス (${_devices.length})'),
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('デバイスがありません', style: TextStyle(color: Colors.grey)),
          ],
        ),
      );
    }
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('自動化ルールがありません', style: TextStyle(color: Colors.grey)),
          ],
        ),
      );
    }
