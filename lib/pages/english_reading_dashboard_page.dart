...
class _EnglishReadingDashboardPageState
  ...
  bool _loading = true;
  String? _error;
  EnglishReadingAbilitySummary _summary =
      EnglishReadingAbilitySummary.empty();
  ...
  Future<void> _fetch() async {
    ...
    try {
      ...
      final attempts = list
          .whereType<Map>()
          .map(
            (e) => EnglishReadingAttempt.fromJson(
  ...
  Widget _buildStatsGrid() {
    final comprehensionPct =
        (_summary.averageComprehension * 100).round();
    final tiles = <Widget>[
      _StatTile(
