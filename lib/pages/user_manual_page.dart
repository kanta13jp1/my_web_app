      ...
      body: ListView(
        ...
        children: [
          ...
          _buildContent(
            ...
            '【統計 & 実績 (バッジ)】\n'
            'ホーム画面「QUICK ACCESS」→「生活・整理」→「統計 & 実績」をタップ。\n'
            '獲得バッジ・連続ログイン記録・ゲーミフィケーションの進捗を確認できます。\n\n'
            '【集中タイマー (Forest競合)】\n'
            'ホーム画面「QUICK ACCESS」→「成長・発信」→「集中タイマー」をタップ。\n'
            'ポモドーロ式タイマー（5/15/25/50分プリセット）でセッションを記録します。\n'
            '完了セッション数・集中合計時間・連続日数・集中スコアを週次統計で確認できます。\n\n'
            '【AI文章アシスタント (Grammarly/Notion AI競合)】\n'
            'ホーム画面「QUICK ACCESS」→「成長・発信」→「AI文章アシスタント」をタップ。\n'
            '文章を入力して6種類のAI支援から選びます:\n'
            '① 文章改善: 読みやすく自然な日本語に校正\n'
            '② 要約: 3〜5行の簡潔なサマリー生成\n'
            '③ 続きを書く: 文章の続きを200字程度自動生成\n'
            '④ 翻訳: 英語・中国語・韓国語など多言語に翻訳\n'
            '⑤ トーン変換: フォーマル/カジュアル/SNS向けなど5トーン\n'
            '⑥ タイトル提案: 20字以内のタイトル候補を5件提案\n'
            '結果はコピーボタンでクリップボードにワンタップコピーできます。',
            subColor,
          ),
          const SizedBox(height: 24),
