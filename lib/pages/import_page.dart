...
class _ImportPageState extends State<ImportPage> {
  ...
  final TextEditingController _externalFormatInputController =
      TextEditingController(text: ExternalFormatService.sampleText('ssim'));
  ...
  void _selectExternalFormat(String? formatId) {
    ...
    setState(() {
      ...
      _externalFormatProfile = ExternalFormatService.defaultProfile(
        nextFormatId,
      );
      _externalFormatInputController.text = ExternalFormatService.sampleText(
        nextFormatId,
      );
            ...
            Wrap(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  label: Text(_isSavingExternalMapping ? '保存中...' : 'マッピングを保存'),
                ),
              ],
            ),
            if (preview != null) ...[
