...
class _GoalDecomposerCardState extends State<GoalDecomposerCard> {
  ...
  static const _deptTemplates = <_DeptDef>[
    _DeptDef(
      'CEO室', 'ceo', Icons.business_center, Color(0xFF4F46E5),
      '全体方針策定・ゴール承認・優先度決定',
    ),
    _DeptDef(
      '企画部', 'planning-director', Icons.lightbulb, Color(0xFFF59E0B),
      '施策アイデア立案・ロードマップ策定',
    ),
    _DeptDef(
      '開発部', 'cto', Icons.code, Color(0xFF10B981),
      '技術実装・アーキテクチャ設計・デプロイ',
    ),
    _DeptDef(
      'CMO室', 'cmo', Icons.campaign, Color(0xFFEC4899),
      'マーケティング戦略・SNS・広告クリエイティブ',
    ),
    _DeptDef(
      '広報部', 'pr-director', Icons.newspaper, Color(0xFF06B6D4),
      'プレスリリース・ブログ投稿・Build in Public',
    ),
    _DeptDef(
      '営業部', 'sales-director', Icons.handshake, Color(0xFF8B5CF6),
      'リード獲得・デモ・クロージング',
    ),
    _DeptDef(
      'CS部', 'cs-director', Icons.support_agent, Color(0xFF0EA5E9),
      'ユーザーサポート・フィードバック収集・FAQ整備',
    ),
    _DeptDef(
      'CFO室', 'cfo', Icons.account_balance, Color(0xFF64748B),
      '予算確保・コスト試算・財務インパクト評価',
    ),
    _DeptDef(
      'CHRO室', 'chro', Icons.people, Color(0xFF14B8A6),
      '採用計画・スキルアップ・チームカルチャー',
    ),
    _DeptDef(
      'CHO室', 'cho', Icons.favorite, Color(0xFFEF4444),
      'メンバー健康管理・モチベーション維持',
    ),
    _DeptDef(
      '法務部', 'legal-director', Icons.gavel, Color(0xFF78716C),
      'リスク審査・利用規約・コンプライアンス確認',
    ),
    _DeptDef(
      '調達部', 'procurement-director', Icons.inventory, Color(0xFF84CC16),
      'ツール・リソース調達・外部委託',
    ),
  ];
