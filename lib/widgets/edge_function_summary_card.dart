...
class _EdgeFunctionSummaryCardState extends State<EdgeFunctionSummaryCard> {
  ...
  static const List<_FnDef> _functions = [
    ...
    _FnDef('get-support-tickets', 'CS チケット一覧 + 返信 (統合)', true, '/admin', '管理者ダッシュボード > CS セクション/返信'),
    ...
    _FnDef('generate-quote-image', '名言画像生成', false, null, 'Quota節約のため未デプロイ (ソースは保持)'),
    ...
    _FnDef('get-competitor-features', '競合機能 + Web 可用性チェック (統合)', true, '/admin', '管理者ダッシュボード > 競合モニタリングカード'),
    ...
    _FnDef('local-election-intelligence', '選挙インテリジェンス', true, '/election-dashboard', '選挙戦略ページ > AI分析'),
    ...
    _FnDef('team-task-manager', 'チームタスク管理', true, '/team-workspace', 'ホーム > チームワーク > タスク'),
    _FnDef('team-collaboration-sync', 'チームコラボ同期', true, '/team-workspace', 'ホーム > チームワーク > 同期'),
    ...
    _FnDef('bookmark-manager', 'ブックマーク管理', true, '/bookmark-sync', 'ホーム > ブックマーク'),
    _FnDef('user-profile-manager', 'ユーザープロフィール管理', true, '/profile-settings', 'ホーム > プロフィール設定'),
    ...
    _FnDef('subscription-management', 'サブスクリプション管理', true, '/profile-settings', 'プロフィール > プラン管理'),
    ...
    _FnDef('revenue-forecaster', '収益予測', true, '/revenue-forecaster', 'ホーム QUICK ACCESS > 収益予測'),
    ...
    _FnDef('ai-summarizer', 'AI 要約', true, '/ai-summarizer', 'ホーム QUICK ACCESS > AI要約'),
    ...
    _FnDef('chat-messaging', 'チャット/メッセージング', true, '/team-workspace', 'チームワーク > チャット'),
    ...
    _FnDef('weather-widget', '天気ウィジェット', true, '/weather-widget', 'ホーム QUICK ACCESS > 天気情報'),
    ...
    _FnDef('realtime-presence', 'リアルタイムプレゼンス', true, '/team-workspace', 'チームワーク > オンライン状態'),
    ...
    _FnDef('ai-workflow-automation', 'AI ワークフロー自動化', true, '/workflow-automation', 'WorkflowAutomationPage'),
    _FnDef('blog-auto-publisher', 'ブログ自動公開', true, '/tech-blog-tracker', 'TechBlogTrackerPage（投稿状態管理）'),
    ...
    _FnDef('subscription-billing', 'サブスクリプション請求', true, '/profile-settings', 'プロフィール > プラン管理'),
    ...
    _FnDef('live-streaming', 'ライブストリーミング', true, '/team-workspace', 'チームワーク > ライブ配信'),
    ...
    _FnDef('encrypted-messaging', '暗号化メッセージング', true, '/team-workspace', 'チームワーク > 暗号化チャット'),
    ...
    _FnDef('bookmark-sync', 'ブックマーク同期 (Pocket競合)', true, '/bookmark-sync', 'ブックマーク管理ページ'),
    _FnDef('note-sharing-enhanced', 'ノート共有強化 (パスワード保護・期限付き)', true, '/note-editor', 'ノートエディタ > 共有設定'),
    _FnDef('focus-timer', '集中タイマー・フォーカスモード (Forest競合)', true, '/focus-timer', 'ホーム > 集中タイマーカード'),
    ...
    _FnDef('schedule-execution-logger', 'Schedule 実行ログ詳細', false, null, 'Quota節約のため未デプロイ (ソースは保持)'),
    _FnDef('user-growth-analytics', 'ユーザー成長分析', false, null, 'Quota節約のため未デプロイ (ソースは保持)'),
    _FnDef('social-proof-generator', 'ソーシャルプルーフ生成', false, null, 'Quota節約のため未デプロイ (ソースは保持)'),
    _FnDef('admin-notification-hub', '管理者通知ハブ', true, '/admin', '管理者ダッシュボード > 通知'),
    _FnDef('edge-function-test-runner', 'Edge Function テストランナー', false, null, 'Quota節約のため未デプロイ (ソースは保持)'),
    ...
    // 追加 (cs-check 自動連携)
    _FnDef('growth-acquisition', '成長獲得統合 (Signal記録+レポート)', true, '/growth-acquisition', '成長獲得ダッシュボードページ'),
