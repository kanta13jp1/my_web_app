...
class _EdgeFunctionSummaryCardState extends State<EdgeFunctionSummaryCard> {
  ...
  static const List<_FnDef> _functions = [
    ...
    _FnDef('crm-sales-pipeline', 'CRM セールスパイプライン', false, null, '未実装'),
    _FnDef('document-esignature', 'ドキュメント電子署名', false, null, '未実装'),
    _FnDef('edge-function-ui-checker', 'Edge Function UI チェッカー', false, null, 'Schedule専用'),
    _FnDef('elearning-course-manager', 'eラーニングコース管理', false, null, '未実装'),
    _FnDef('event-ticketing', 'イベントチケット管理', false, null, '未実装'),
    _FnDef('fitness-health-tracker', 'フィットネス・健康トラッカー', false, null, '未実装'),
    _FnDef('form-builder', 'フォームビルダー', false, null, '未実装'),
    _FnDef('gantt-timeline-manager', 'ガントチャート・タイムライン', false, null, '未実装'),
    _FnDef('home-iot-manager', 'ホーム IoT 管理', false, null, '未実装'),
    _FnDef('horse-racing-predictor', '競馬予測 AI', false, null, '未実装'),
    _FnDef('issue-auto-resolver', 'Issue 自動解決', false, null, 'Schedule専用'),
    _FnDef('language-learning', '語学学習', false, null, '未実装'),
    _FnDef('legal-compliance-manager', '法務・コンプライアンス管理', false, null, '未実装'),
    _FnDef('music-playlist-manager', '音楽プレイリスト管理', false, null, '未実装'),
    ...
    _FnDef('social-media-scheduler', 'SNS 投稿スケジューラー', false, null, '未実装'),
    ...
    _FnDef('subscription-billing', 'サブスクリプション請求', true, '/subscription-billing', 'サブスクリプション請求ページ'),
    _FnDef('workflow-templates', 'ワークフローテンプレート', true, '/workflow-templates', 'ワークフローテンプレートページ'),
    _FnDef('cloud-storage-sync', 'クラウドストレージ同期', false, null, '未実装'),
    _FnDef('virtual-whiteboard', 'バーチャルホワイトボード', false, null, '未実装'),
    _FnDef('marketplace-reviews', 'マーケットプレイスレビュー', false, null, '未実装'),
    _FnDef('smart-home-automation', 'スマートホーム自動化', false, null, '未実装'),
    _FnDef('digital-wallet', 'デジタルウォレット', false, null, '未実装'),
    _FnDef('loyalty-points', 'ロイヤルティポイント', false, null, '未実装'),
    _FnDef('live-streaming', 'ライブストリーミング', false, null, '未実装'),
    _FnDef('geo-checkin', 'ジオチェックイン', false, null, '未実装'),
    _FnDef('social-stories', 'ソーシャルストーリーズ', false, null, '未実装'),
    _FnDef('encrypted-messaging', '暗号化メッセージング', false, null, '未実装'),
    _FnDef('compliance-checker', 'コンプライアンスチェック', false, null, '未実装'),
    _FnDef('user-onboarding', 'ユーザーオンボーディング', false, null, '未実装'),
    _FnDef('rate-limiter-enhanced', 'レートリミッター拡張', false, null, 'サーバーサイド専用'),
    _FnDef('content-versioning', 'コンテンツバージョン管理', false, null, '未実装'),
    _FnDef('custom-dashboard-builder', 'カスタムダッシュボードビルダー', false, null, '未実装'),
    _FnDef('api-docs-generator', 'API ドキュメント生成', false, null, '未実装'),
    _FnDef('audit-trail', '監査ログ', false, null, '未実装'),
    _FnDef('backup-restore', 'バックアップ・リストア', false, null, '未実装'),
    _FnDef('data-pipeline', 'データパイプライン', false, null, 'Schedule専用'),
    _FnDef('data-visualization', 'データビジュアライゼーション', false, null, '未実装'),
    _FnDef('multi-language', '多言語対応', false, null, '未実装'),
