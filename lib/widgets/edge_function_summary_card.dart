...
class _EdgeFunctionSummaryCardState extends State<EdgeFunctionSummaryCard> {
  ...
  static const List<_FnDef> _functions = [
    ...
    _FnDef(
      'edge-function-ui-checker',
      'Edge Function UI チェッカー',
      false,
      null,
      'Schedule専用',
    ),
    ...
    _FnDef(
      'note-sharing-enhanced',
      'ノート共有強化 (パスワード保護・期限付き)',
      true,
      '/note-editor',
      'ノートエディタ > 共有設定',
    ),
    ...
    _FnDef(
      'viral-share-engine',
      'バイラルシェアエンジン (UTMリンク・シェア係数)',
      true,
      '/viral-ad-campaign',
      'バイラルキャンペーン > シェアリンク生成',
    ),
    _FnDef(
      'schedule-execution-logger',
      'Schedule 実行ログ詳細',
      false,
      null,
      'Quota節約のため未デプロイ (ソースは保持)',
    ...
    _FnDef(
      'youtube-stats',
      'YouTube チャンネル統計管理 (TSVインポート)',
      true,
      '/youtube-stats',
      'YouTube統計管理ページ > TSVインポート・統計一覧',
    ),
    // 追加 (cs-check 自動連携)
    _FnDef(
      'submit-feedback',
      'フィードバック投稿・通知 (確認メール + GitHub Issue)',
      true,
      '/feedback',
      'フィードバックページ > 投稿フォーム',
    ),
