...
const _notionFeatureRows = <_FeatureRow>[
  ...
  _FeatureRow(
    ...
    status: _FeatureStatus.done,
    appDetail: '最新30件のスナップショット保存・復元対応 (2026-03-28実装)',
  ),
  _FeatureRow(
    category: 'ノート編集',
    feature: 'ファイル添付',
  ...
  _FeatureRow(
    ...
    status: _FeatureStatus.done,
    appDetail: 'ILIKE フォールバック付きハイブリッド検索実装済み・NoteSearchCard対応 (2026-03-28)',
  ),
  _FeatureRow(
    category: '整理・検索',
    feature: 'テンプレート',
    ...
    status: _FeatureStatus.done,
    appDetail: '6カテゴリ18種テンプレートマーケット実装済み (2026-03-28)',
  ),
  // ---- データベース ----
  _FeatureRow(
    category: 'データベース',
    ...
    status: _FeatureStatus.done,
    appDetail: '動的カラム定義・5型対応・DataTable横スクロール実装済み (2026-03-28)',
  ),
  _FeatureRow(
    category: 'データベース',
    feature: 'カンバン/ボード',
    ...
    status: _FeatureStatus.done,
    appDetail: 'KanbanBoardPage 実装済み・ステータス別カード管理対応',
  ),
  _FeatureRow(
    category: 'データベース',
    feature: 'カレンダービュー',
