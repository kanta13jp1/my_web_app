...
void main() {
  ...
  test('公開ノートに自民参考値と公認予定候補が載る (共有面の欠落防止)', () {
    ...
    expect(draft.content, contains('公認予定候補: 264件'));
    expect(draft.content, contains('36/47都道府県に掲載'));
    ...
    expect(draft.metadata['officialEndorsementTotal'], 264);
    expect(draft.metadata['officialEndorsementAsOf'], '2026-08-19');
    expect(draft.metadata['firstEndorsementTotal'], 264);
