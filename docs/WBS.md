...
### 笞呻ｸ・繧ｫ繝・ざ繝ｪ1: 繧､繝ｳ繝輔Λ繝ｻCI/CD 窶・**PowerShell迚・/ Codex 荳譎ょｼ慕ｶ吶℃**

| 繧ｿ繧ｹ繧ｯ | 迥ｶ諷・| 騾ｲ謐・| ﾎｱ/ﾎｲ/v1 |
|---|---|---|---|
| EF繝上・繝峨く繝｣繝・・16譛ｬ邯ｭ謖・| 泯騾ｲ陦御ｸｭ | 90% | ﾎｱ |
| deploy-prod 謌仙粥邇・00%邯ｭ謖・| 泯騾ｲ陦御ｸｭ | 80% | ﾎｱ |
| BYPASS_RULES secret險ｭ螳・(Codex蠑慕ｶ吶℃) | 泯騾ｲ陦御ｸｭ | 70% | ﾎｱ |
| cs-check譛驕ｩ蛹門ｮ御ｺ・| 笨・ｮ御ｺ・| 100% | ﾎｱ |
| orphan branch 0譛ｬ邯ｭ謖・| 笨・ｮ御ｺ・| 100% | ﾎｱ |
| Rule17 WF health weekly螳滓命 | 泯騾ｲ陦御ｸｭ | 70% | ﾎｲ |
...
1. BYPASS_RULES secret險ｭ螳・(Codex蠑慕ｶ吶℃) 窶・騾ｲ陦御ｸｭ (secret蟄伜惠遒ｺ隱阪・螳牙・繝ｭ繝ｼ繝・・繧ｷ繝ｧ繝ｳ謇矩・ｮ御ｺ・
