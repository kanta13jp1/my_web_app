...
> **最終更新**: 2026-04-21 Codex (Claude quota 制限に伴う frontend/comparison 引き継ぎ)
...
- 主担当を `Codex` に切り替えた対象:
  ...
  `競合比較ページ最新化`
- 本番 WBS では `owner_instance = codex` を正式値として扱う。
- `schedule` の自動運用タスクを含む未完了 WBS タスク全件を Codex owner に集約した。
- 比較ページ刷新の反映に合わせて、上記 3 タスクの進捗を更新した。
...
### ⚙️ カテゴリ1: インフラ・CI/CD — **Codex 担当**

| タスク | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|
| EFハードキャップ16本維持 | 🟡進行中 | 90% | α |
| deploy-prod 成功率100%維持 | 🟡進行中 | 80% | α |
| BYPASS_RULES secret設定 (着手予定 — GitHub Co-Pilot 担当) | ⚪未着手 | 0% | α |
| cs-check最適化完了 | ✅完了 | 100% | α |
| orphan branch 0本維持 | ✅完了 | 100% | α |
| Rule17 WF health weekly実施 (着手予定 — GitHub Co-Pilot 担当) | 🟡進行中 | 70% | β |

### 🎨 カテゴリ2: デザインシステム — **Codex 担当**

| タスク | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|
| DESIGN.md全ページ準拠 60%達成 (着手予定 — GitHub Co-Pilot 担当) | 🟡進行中 | 65% | α |
| モバイルレスポンシブ完全対応 (着手予定 — GitHub Co-Pilot 担当) | 🟡進行中 | 70% | α |
| タイポグラフィ統一 | 🟡進行中 | 50% | β |
...
| タスク | 担当 | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|---|
| 78社コンテンツ完全化 | GitHub Co-Pilot | 🟡進行中 | 85% | α |
| FSRS学習システム完全実装 | GitHub Co-Pilot | 🟡進行中 | 90% | α |
| ストリーク・バッジ・ランキング | Codex | ✅完了 | 100% | α |
| AIプロバイダー一覧・チャット機能 | Codex | ✅完了 | 100% | α |
| AI大学 100社達成 | Codex | ⚪未着手 | 0% | β |
| 音声学習機能強化 | Codex | 🟡進行中 | 40% | β |

### 💼 カテゴリ4: コアSaaS機能 — **Codex 担当**

| タスク | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|
| ノート・メモ機能 (Notion対抗) (着手予定 — GitHub Co-Pilot 担当) | 🟡進行中 | 60% | β |
...
| タスク | 担当 | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|---|
| ai-hub 502エラー根本修正 | Codex | ✅完了 | 100% | α |
| ai-hub provider.chat 全対応 | GitHub Co-Pilot | 🟡進行中 | 20% | β | (13/78社実装 — Windows#74で OpenAI互換8+独自3+特殊2 追加)
| AIアシスタント Opus4.7/Sonnet4.6更新 | Codex | 🟡進行中 | 80% | α |
| 画像生成統合 | Codex | ⚪未着手 | 0% | v1 |
| マルチモーダルAI | Codex | ⚪未着手 | 0% | v1 |

### 📈 カテゴリ6: グロース自動化 — **Codex 担当**

| タスク | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|
| ブログ自動投稿安定化 (Qiita/dev.to) (着手予定 — GitHub Co-Pilot 担当) | 🟡進行中 | 75% | α |
...
### 🛡️ カテゴリ8: 品質・安定性 — **全インスタンス (Codex で主要割当)**

| タスク | 担当 | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|---|
| flutter analyze 0エラー常時維持 | Codex | 🟡進行中 | 85% | α |
| deno lint 0エラー維持 | Codex | 🟡進行中 | 90% | α |
| Webパフォーマンス最適化 | Codex | ⚪未着手 | 20% | β |
| E2Eテスト整備 (Playwright) | Codex | ⚪未着手 | 0% | v1 |
| エラー監視強化 (Sentry連携) | Codex | ⚪未着手 | 0% | v1 |
