...
- `schedule` の自動運用タスクは既存担当のままとし、未完了の開発タスクは Codex owner に集約した。
...
| タスク | 状態 | 進捗 | α/β/v1 |
|---|---|---|---|
| DESIGN.md全ページ準拠 60%達成 | 🟡進行中 | 65% | α |
| モバイルレスポンシブ完全対応 | 🟡進行中 | 70% | α |
| タイポグラフィ統一 | 🟡進行中 | 50% | β |
...
| ai-hub provider.chat 全対応 | Codex | 🟡進行中 | 20% | β | (13/78社実装 — Windows#74で OpenAI互換8+独自3+特殊2 追加)
...
| deno lint 0エラー維持 | Codex | 🟡進行中 | 85% | α |
