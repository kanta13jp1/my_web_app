...
作成日: 2025-11-10
最終更新: 2026-04-01 session432w-web (225 Edge Functions体制: Supabase 100関数制限対策 — deploy-prod.yml をTier 1/Tier 2に分割し、最重要100関数のみデプロイ)
現時点の登録者数: 4人
...
- **Tier 2 (コードのみ)**: 残り125+関数はコードベースに存在するが未デプロイ。Supabaseプラン上限緩和後に順次有効化
