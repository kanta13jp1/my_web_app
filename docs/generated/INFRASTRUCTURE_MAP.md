...
- Source revision: `a72830d702c0b0d49bd37d0f8c0f324ade11f593`
- Source commit time: `2026-08-31T00:17:02+09:00`
...
flowchart LR
  ...
  r_b78b9fa552["private.audit_artifact_candidate_transition"]
  r_533aecb227["private.audit_artifact_check_update"]
  r_1b60367291["private.audit_artifact_publication_run"]
  ...
  r_f9ded1e513["private.seed_and_audit_artifact_candidate"]
...
| `public.video_generation_jobs` | 13 |
| `public.agents` | 11 |
| `public.agent_tasks` | 9 |
| `public.artifact_candidates` | 9 |
| `public.shop_products` | 9 |
| `public.video_artifacts` | 9 |
| `public.musubi_profiles` | 8 |
| `public.teams` | 7 |
| `public.account_deletion_requests` | 6 |
| `public.video_artifact_reviews` | 6 |
...
| `public.wbs_tasks` | 5 |
| `storage.objects` | 5 |
| `public.agent_runtime_job_runs` | 4 |
| `public.company_agent_events` | 4 |
...
| `public.video_authorize_and_reserve_improvement` | RPC/function | [`supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql`](../../supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql) |
...
| `public.video_reserve_authorized_improvement` | RPC/function | [`supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql`](../../supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql) |
...
| `public.video_settle_improvement_authorization` | RPC/function | [`supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql`](../../supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql) |
...
| `public.ai_usage_log` | table | [`supabase/migrations/20251107000000_ai_features.sql`](../../supabase/migrations/20251107000000_ai_features.sql) |
...
| `public.video_artifact_events` | table | [`supabase/migrations/20260822084126_add_video_artifact_review_loop.sql`](../../supabase/migrations/20260822084126_add_video_artifact_review_loop.sql) |
...
| `public.video_improvement_authorizations` | table | [`supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql`](../../supabase/migrations/20260830053403_video_improvement_authorization_envelopes.sql) |
...
| Supabase Network Restrictions 管理 | push<br>workflow_dispatch | 1 | Supabase platform | [`.github/workflows/fix-supabase-network.yml`](../../.github/workflows/fix-supabase-network.yml) |
