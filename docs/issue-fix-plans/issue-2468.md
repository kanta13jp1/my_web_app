...
- Issue: [[追加要望][P2][資産管理][第2弾B] 投資資産入力form+一覧UI](https://github.com/kanta13jp1/my_web_app/issues/2468)
- Labels: enhancement,ui,priority:medium,flutter,追加要望
- Workflow: `.github/workflows/github-issue-fix.yml`
- CI repair pair: `.github/workflows/ci-auto-fix.yml`
- Run: https://github.com/kanta13jp1/my_web_app/actions/runs/28140621261

## Goal

[追加要望][P2][資産管理][第2弾B] 投資資産入力form+一覧UI
...
## スコープ
- 銘柄追加 form (type/ticker/数量/取得価格/取得日)
- 一覧 widget (= 銘柄/評価額/損益/比率%)
- 編集・削除 action
