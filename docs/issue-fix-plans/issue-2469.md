...
- Issue: [[追加要望][P2][資産管理][第2弾B] 投資資産推移graph (1y/3y/lifetime)](https://github.com/kanta13jp1/my_web_app/issues/2469)
- Labels: enhancement,ui,priority:medium,flutter,追加要望
- Workflow: `.github/workflows/github-issue-fix.yml`
- CI repair pair: `.github/workflows/ci-auto-fix.yml`
- Run: https://github.com/kanta13jp1/my_web_app/actions/runs/29304234025

## Goal

[追加要望][P2][資産管理][第2弾B] 投資資産推移graph (1y/3y/lifetime)
...
## スコープ
- 評価額時系列 line chart (= fl_chart)
- 期間 toggle (1y/3y/lifetime)
- 取得額 base line 表示
