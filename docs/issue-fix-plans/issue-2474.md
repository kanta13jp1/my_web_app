...
- Issue: [[追加要望][P2][資産管理][第2弾C] キャッシュフロー panel (月収-月支出+累積)](https://github.com/kanta13jp1/my_web_app/issues/2474)
- Labels: enhancement,ui,priority:medium,flutter,追加要望
- Workflow: `.github/workflows/github-issue-fix.yml`
- CI repair pair: `.github/workflows/ci-auto-fix.yml`
- Run: https://github.com/kanta13jp1/my_web_app/actions/runs/29672739116

## Goal

[追加要望][P2][資産管理][第2弾C] キャッシュフロー panel (月収-月支出+累積)
