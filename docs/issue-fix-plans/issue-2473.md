...
- Issue: [[追加要望][P2][資産管理][第2弾C] 純資産 panel (前月比+グラフ)](https://github.com/kanta13jp1/my_web_app/issues/2473)
- Labels: enhancement,ui,priority:medium,flutter,追加要望
- Workflow: `.github/workflows/github-issue-fix.yml`
- CI repair pair: `.github/workflows/ci-auto-fix.yml`
- Run: https://github.com/kanta13jp1/my_web_app/actions/runs/29629265527

## Goal

[追加要望][P2][資産管理][第2弾C] 純資産 panel (前月比+グラフ)
