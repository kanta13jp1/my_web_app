# PR Skeleton: [ai-tool-watch] 2026-07-09 official AI tool changes: Claude Code hooks reference, Codex changelog, Codex use cases

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-07-09 official updates`
