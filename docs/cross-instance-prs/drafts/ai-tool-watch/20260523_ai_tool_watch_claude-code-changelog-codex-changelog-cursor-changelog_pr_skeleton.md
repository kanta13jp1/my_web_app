# PR Skeleton: [ai-tool-watch] 2026-05-23 official AI tool changes: Claude Code changelog, Codex changelog, Cursor changelog, +1

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-05-23 official updates`
