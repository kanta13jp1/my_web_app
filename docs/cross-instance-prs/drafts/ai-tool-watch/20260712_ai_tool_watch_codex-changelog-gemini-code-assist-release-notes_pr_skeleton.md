# PR Skeleton: [ai-tool-watch] 2026-07-12 official AI tool changes: Codex changelog, Gemini Code Assist release notes

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-07-12 official updates`
