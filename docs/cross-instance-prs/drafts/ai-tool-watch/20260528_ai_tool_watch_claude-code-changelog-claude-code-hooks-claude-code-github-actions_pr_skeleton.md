# PR Skeleton: [ai-tool-watch] 2026-05-28 official AI tool changes: Claude Code changelog, Claude Code hooks reference, Claude Code GitHub Actions, +2

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-05-28 official updates`
