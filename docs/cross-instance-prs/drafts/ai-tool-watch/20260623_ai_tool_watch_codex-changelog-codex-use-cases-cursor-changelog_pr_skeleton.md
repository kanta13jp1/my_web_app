# PR Skeleton: [ai-tool-watch] 2026-06-23 official AI tool changes: Codex changelog, Codex use cases, Cursor changelog

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-06-23 official updates`
