# PR Skeleton: [ai-tool-watch] 2026-06-25 official AI tool changes: Claude Code changelog, Claude Code hooks reference, Codex changelog, +2

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-06-25 official updates`
