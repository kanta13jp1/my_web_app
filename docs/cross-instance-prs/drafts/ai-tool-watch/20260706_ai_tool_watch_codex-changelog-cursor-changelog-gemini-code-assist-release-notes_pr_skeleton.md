# PR Skeleton: [ai-tool-watch] 2026-07-06 official AI tool changes: Codex changelog, Cursor changelog, Gemini Code Assist release notes, +1

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-07-06 official updates`
