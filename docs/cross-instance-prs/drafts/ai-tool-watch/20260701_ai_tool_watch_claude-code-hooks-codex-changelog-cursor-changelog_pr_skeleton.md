# PR Skeleton: [ai-tool-watch] 2026-07-01 official AI tool changes: Claude Code hooks reference, Codex changelog, Cursor changelog, +1

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-07-01 official updates`
