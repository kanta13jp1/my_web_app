# PR Skeleton: [ai-tool-watch] 2026-07-20 official AI tool changes: Claude Code hooks reference, Cursor changelog

Auto-generated by `scripts/ai_tool_watch_route.py`.

## Proposed PR Title

`chore(ai-tool): route 2026-07-20 official updates`
