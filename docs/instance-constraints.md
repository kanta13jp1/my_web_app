...
> ⚠️ **2026-04-17 段階的廃止中**: 正式版は **[`docs/INSTANCE_CONFIG.md`](INSTANCE_CONFIG.md)** に一本化された。
> 本ファイルは過去の制約発見ログとして参照専用。新規制約は `INSTANCE_CONFIG.md` に追記すること。
> WEB版関連の記載 (下記行13-17等) は 2026-04-17 の WEB版廃止により非アクティブ。

> **従来の更新ルール (参考)**: 新しい制約・仕様変更を発見したセッションが **即このファイルに追記** し、
