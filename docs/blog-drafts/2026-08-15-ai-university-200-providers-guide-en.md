...
### LLM APIs (2)
4. **Anthropic Claude** (API) — Long-form, code, reasoning
5. **Google Gemini** (API) — Image, video, multimodal

### Agents (1)
6. **LangGraph** (OSS) — State-machine-controlled agents

### Search & Data (2)
7. **Tavily** — Real-time web search designed for LLMs
8. **Firecrawl** — Web scraping to clean Markdown

### Research (2)
9. **NotebookLM** (free) — Document analysis, Deep Research
10. **Perplexity** ($20/month) — Real-time answers with citations
...
→ [Explore all 230+ providers in Jibun Kaisha's AI University](https://my-web-app-b67f4.web.app/)
