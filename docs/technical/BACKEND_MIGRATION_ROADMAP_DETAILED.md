...
> **⚠️ アーカイブ済 (2026-04-12 Windows版#56 確認)**: このドキュメントは 2025年11月時点の移行計画です。
> Edge Function ファーストアーキテクチャは 15本 hub 体制として完全実施済み。現状は `docs/GROWTH_STRATEGY_ROADMAP.md` を参照してください。
