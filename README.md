...
**Geminiへのコンテキスト提供ルール**:
開発を開始する際は、**必ず以下の10個のファイルの内容**をプロンプトに含めてください。これにより、仕様、設計、DB構造、テスト状況、コード品質、ビルド状態、そしてユーザー操作手順を網羅的に把握できます。
...
8. **BUILD_LOG.md** (最新ビルドログ: コンパイル成否)
9. **USER_MANUAL.md** (ユーザーマニュアル: 操作手順と機能仕様)
10. **DETAILED_DESIGN.md** (詳細設計書: アーキテクチャと内部ロジック)