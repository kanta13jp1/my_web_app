...
#### 現在の登録プロバイダー (Windows版#44 時点: 20社)

```text
google, openai, anthropic, microsoft, meta, x, deepseek, mistral, perplexity, groq, cohere, amazon, stability, huggingface, nvidia, ibm, sakana, baidu, oracle, reka
```
...
**次回追加候補**: Aleph Alpha (aleph) / Together AI (together) / Cohere (cohere-standalone)
