...
| **WEB版 (Claude Code)** | `docs/blog-drafts/` + `docs/research/` | WebSearch/WebFetch **直接リサーチ専任** (notebooklm CLI 不可) / GitHub MCP 経由 PR・Issue 管理 / ブログ英語翻訳 / Opus 4.6 + ultrathink でアーキテクチャレビュー |
