...
#### 現在の登録プロバイダー (Windows版#36 時点: 13社)

```text
google, openai, anthropic, microsoft, meta, x, deepseek, mistral, perplexity, groq, cohere, amazon, stability
```
...
**次回追加候補**: Nvidia NIM (nvidia) / Hugging Face (huggingface) / Baidu ERNIE (baidu)
