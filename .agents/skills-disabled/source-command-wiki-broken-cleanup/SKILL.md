---
name: "source-command-wiki-broken-cleanup"
...
# source-command-wiki-broken-cleanup

Use this skill when the user asks to run the migrated source command `wiki-broken-cleanup`.
...
backtick 化する slash command。裏側は `.Codex/skills/wiki-broken-cleanup/SKILL.md`
...
- skill: `wiki-broken-cleanup` (.Codex/skills/wiki-broken-cleanup/SKILL.md)
