---
name: "source-command-wiki-orphan-batch"
...
# source-command-wiki-orphan-batch

Use this skill when the user asks to run the migrated source command `wiki-orphan-batch`.
...
batch wikilink 化する slash command。裏側は `.Codex/skills/wiki-orphan-batch/SKILL.md`
...
- skill: `wiki-orphan-batch` (.Codex/skills/wiki-orphan-batch/SKILL.md)
