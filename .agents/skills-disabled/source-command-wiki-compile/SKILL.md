---
name: "source-command-wiki-compile"
...
# source-command-wiki-compile

Use this skill when the user asks to run the migrated source command `wiki-compile`.
...
裏側は `.Codex/skills/wiki-compile/SKILL.md` (Layer 3-5 Agent Skill / part 139) を経由し、
...
- skill: `wiki-compile` (.Codex/skills/wiki-compile/SKILL.md)
