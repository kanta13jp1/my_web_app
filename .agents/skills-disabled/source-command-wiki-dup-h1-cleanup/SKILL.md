---
name: "source-command-wiki-dup-h1-cleanup"
...
# source-command-wiki-dup-h1-cleanup

Use this skill when the user asks to run the migrated source command `wiki-dup-h1-cleanup`.
...
slash command。裏側は `.Codex/skills/wiki-dup-h1-cleanup/SKILL.md`
...
- skill: `wiki-dup-h1-cleanup` (.Codex/skills/wiki-dup-h1-cleanup/SKILL.md)
