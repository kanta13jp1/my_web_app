...
# source-command-wrap-up

Use this skill when the user asks to run the migrated source command `wrap-up`.
...
- AGENTS.md / COMPRESSED_PROMPT_V3.md に追記すべき新ルール・数値更新
- インスタンス分担の変更点
...
**保存先**: `C:\Users\kanta\.Codex\projects\C--Users-kanta-GitHub-my-web-app\memory\`
...
notebooklm source add "C:/Users/kanta/.Codex/projects/C--Users-kanta-GitHub-my-web-app/memory/feedback_success_YYYYMMDD.md"
notebooklm source add "C:/Users/kanta/.Codex/projects/C--Users-kanta-GitHub-my-web-app/memory/feedback_correction_YYYYMMDD.md"
notebooklm source add "C:/Users/kanta/.Codex/projects/C--Users-kanta-GitHub-my-web-app/memory/project_YYYYMMDD.md"
```
