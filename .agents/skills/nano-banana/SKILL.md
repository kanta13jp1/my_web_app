---
name: nano-banana
description: Generate UI images, icons, OGP images, and mockups with the Google Gemini image API. Use when this repository needs Gemini-based image generation and GEMINI_API_KEY is available.
---
...
このスキルにより Codex がプロンプトからUI画像・アイコン・OGP画像を生成できる。
