...
export const ACTION_POLICIES = {
  ...
  "maintenance.create": { auth: "service_role", sideEffect: "system_write" },
  "maintenance.update": { auth: "service_role", sideEffect: "system_write" },
  "maintenance.delete": { auth: "service_role", sideEffect: "system_write" },
