...
serve(async (req) => {
  ...
  try {
    ...
    if (req.method === "GET") {
      ...
      // Edge Function 数
      const edgeFunctionCount = 120; // 115 + 5 (session432b: push-notification-manager, realtime-presence, voice-memo-transcriber, ocr-document-scanner, oauth-sso-provider)
