...
export const quotes: PhilosopherQuote[] = [
  {
  ...
  },
  {
    ...
    author: "ソクラテス",
    imageUrl:
      "https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?w=800&h=800&fit=crop",
    authorDescription: "古代ギリシアの哲学者",
  },
  {
    quote: "知恵の始まりは定義にあり。",
  ...
  },
  {
    ...
    author: "ジャン＝ポール・サルトル",
    imageUrl:
      "https://images.unsplash.com/photo-1528892952291-009c663ce843?w=800&h=800&fit=crop",
  ...
  {
    quote:
      "愛するということは、愛される者の成長と幸福を積極的に求めることである。",
    author: "エーリッヒ・フロム",
    imageUrl:
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&h=800&fit=crop",
    authorDescription: "ドイツの精神分析学者・社会心理学者",
...
export function getRandomQuote(): PhilosopherQuote {
  const randomIndex = Math.floor(Math.random() * quotes.length);
  return quotes[randomIndex];
}

export function getQuoteById(id: number): PhilosopherQuote {
