...
set
  ...
  recovery_plan = CASE WHEN COALESCE(recovery_plan, '') = '' THEN 'Completed same day (2026-04-25): Harvey LP positioning strengthened. Follow-up migration marks task completed.' ELSE recovery_plan END,
  description = case
