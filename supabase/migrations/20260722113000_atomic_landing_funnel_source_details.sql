-- Preserve anonymous LP funnel events under RLS and concurrent requests.
...
BEGIN
  IF p_source_key IS NULL
     ...
     OR NOT (
       ...
       OR p_source_key ~ '^lp_exp_h(0[1-9]|10)_(control|treatment)_(view|hero_cta|intent|trial|save_cta|signup_submit|signup_complete|sticky_cta)$'
