...
set
  ...
  recovery_plan = coalesce(recovery_plan, 'Completed same day (2026-04-25): Legal AI genre positioning strengthened in AI University. Follow-up migration marks task completed.'),
  description = case
