-- Expand the privacy-minimized first_user_growth cohort from the original X
-- launch lane to the approved Zenn fallback article. RLS and service-role-only
...
ALTER TABLE public.first_user_acquisition_events
  ...
  CHECK (utm_source IN ('x', 'zenn')) NOT VALID;
